...
const bots = [
  { name: 'Buddymixed1Bot',  category: 'MIXED'       as const },
  { name: 'BuddyMs1Bot',     category: 'MOM_SON'     as const },
  { name: 'BuddySLBot',      category: 'SRI_LANKAN'  as const },
  { name: 'Buddycctv1Bot',   category: 'CCTV'        as const },
  { name: 'BuddyPublicBot',  category: 'PUBLIC'      as const },
  { name: 'BuddyRkpeBot',    category: 'RAPE'        as const },
];
